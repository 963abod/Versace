...
const INITIAL_DATA: StoreData = {
  settings: {
    ...
    heroDescription: 'اكتشف التشكيلة الجديدة الفاخرة لعام 2025 المصممة للرجل العصري الأنيق.',
    heroDescriptionEn: 'Discover the new luxury 2025 collection crafted for the modern gentleman.',
    ...
    aboutUs: 'تأسست دار الأثاث والأزياء الفاخرة لتقديم أحدث صيحات الموضة العالمية للرجل العصري. نتميز بتوفير أرقى خامات الأقمشة والتصاميم المبتكرة التي تعكس شخصية الرجل الواثق.',
    ...
    footerText: 'جميع الحقوق محفوظة © 2025 VERSACE',
  ...
  collections: [
    ...
    },
    {
      ...
      description: 'أرقى أنواع القطن المصري والحرير الطبيعي.',
